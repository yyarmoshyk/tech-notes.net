...
run-minimal-mistakes-docs:
	docker run --name jekyll-run --rm -v "${PWD}/public:/myblog/public" -v "${PWD}/minimal-mistakes/docs:/myblog" -p 4000:4000 -it jekyll-image /bin/bash -c "cd /myblog; bundle install; bundle exec jekyll serve"
